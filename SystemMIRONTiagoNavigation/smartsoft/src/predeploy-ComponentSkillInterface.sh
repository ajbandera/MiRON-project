#!/bin/bash
#
# This script is run prior to deployment of component ComponentSkillInterface
...
source $REFERENCED_PROJECT_ComponentSkillInterface/smartsoft/src/predeploy.sh
