#!/bin/bash
#
# Start-Stop-Hooks for component ComponentSkillInterface
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentSkillInterface.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentSkillInterface.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentSkillInterface.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentSkillInterface.sh post-stop
